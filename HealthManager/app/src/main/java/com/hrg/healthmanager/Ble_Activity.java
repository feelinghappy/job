...
import com.hrg.healthmanager.service.BluetoothLeService;
//import com.huicheng.service.BluetoothLeService.LocalBinder;    //反编译找不到这个文件
import com.hrg.healthmanager.Infoadmin.checkitem.checktheitems;
        ...
        implements View.OnClickListener
{
  ...
  //                      Ble_Activity.this.imageID = Ble_Activity.this.getResources().getIdentifier(Ble_Activity.this.manPatchString + "1", "drawable", Ble_Activity.this.getPackageName());
                        imageID = getResources().getIdentifier(String.valueOf(manpictrueindex), "drawable", getPackageName());
                        Ble_Activity.this.compassimgImageView.setImageResource(Ble_Activity.this.imageID);
                    ...
                    if(loop==1)
                    {
                        ...
                        if (loop < 1)
                        {
                            ...
                            Log.e("manpictrueindex","manpictrueindex="+manpictrueindex);
                            String dot = "";
                            Ble_Activity.this.imageID = Ble_Activity.this.getResources().getIdentifier(Ble_Activity.this.manPatchString + String.valueOf(Ble_Activity.this.manpictrueindex), "drawable", Ble_Activity.this.getPackageName());
                            Ble_Activity.this.compassimgImageView.setImageResource(Ble_Activity.this.imageID);
                            i++;
                            if (manpictrueindex == 9) {
                                Random ra = new Random();
                                ran = ra.nextInt(6);
                                displayresult(ran);
                            } else if (manpictrueindex == 10) {
                                Random ra = new Random();
                                ran = ra.nextInt(6);
                                displayresult(ran);
                            } else if (manpictrueindex == 28) {
                                ran = 0;
                                Random ra = new Random();
                                ran = ra.nextInt(6);
                                displayresult(ran);
                            } else if (manpictrueindex == 19) {
                                ran = 0;
                                Random ra = new Random();
                                ran = ra.nextInt(6);
                                displayresult(ran);
                            } else if (manpictrueindex == 30) {
                                ran = 0;
                                Random ra = new Random();
                                ran = ra.nextInt(6);
                                displayresult(ran);
                            } else if (manpictrueindex == 31) {
                                ran = 0;
                                Random ra = new Random();
                                ran = ra.nextInt(6);
                                displayresult(ran);
                            } else if (manpictrueindex == 38) {
                                ran = 0;
                                Random ra = new Random();
                                ran = ra.nextInt(6);
                                displayresult(ran);
                            } else if (manpictrueindex == 39) {
                                ran = 0;
                                Random ra = new Random();
                                ran = ra.nextInt(6);
                                displayresult(ran);
                            } else if (manpictrueindex == 73) {
                                Random ra = new Random();
                                ran = ra.nextInt(6);
                                displayresult(ran);
                            } else if (manpictrueindex == 48) {
                                ran = 0;
                                Random ra = new Random();
                                ran = ra.nextInt(6);
                                displayresult(ran);
                            } else if ((manpictrueindex == 54) || (manpictrueindex == 69) || (manpictrueindex == 76) || (manpictrueindex == 85) || (manpictrueindex == 92)) {
                                ran = 0;
                                Random ra = new Random();
                                ran = ra.nextInt(6);
                                displayresult(ran);
                            } else if ((manpictrueindex == 57) || (manpictrueindex == 70) || (manpictrueindex == 77) || (manpictrueindex == 86) || (manpictrueindex == 93)) {
                                ran = 0;
                                Random ra = new Random();
                                ran = ra.nextInt(6);
                                displayresult(ran);
                        ...
                        if (manpictrueindex == 92) {
                            loop = 1;
                            startflag = false;
                            send_btn.setEnabled(true);
                            btn_startButton.setEnabled(true);
                            connect_state.setText("检测完成");
                            Log.e("loop",loop+"");
                        }
                        return;
    ...
    private void init()
    {
        this.compassimgImageView = ((ImageView)findViewById(R.id.compass_img));// public static final int compass_img = 2131165192;
        this.connect_state = ((TextView)findViewById(R.id.connect_state));//public static final int connect_state = 2131165188;
        this.send_btn = ((Button)findViewById(R.id.send_btn));// public static final int send_btn = 2131165191;
        ...
        this.ls1 = ((LinearLayout)findViewById(R.id.layouts1));//public static final int layouts1 = 2131165193;
        this.ls2 = ((LinearLayout)findViewById(R.id.layouts2));//public static final int layouts2 = 2131165195;
        this.ls3 = ((LinearLayout)findViewById(R.id.layouts3));
        this.ls4 = ((LinearLayout)findViewById(R.id.layouts4));
        this.ls5 = ((LinearLayout)findViewById(R.id.layouts5));
        this.ls6 = ((LinearLayout)findViewById(R.id.layouts6));
    ...
    protected void onCreate(Bundle paramBundle)
    {
        ...
        setContentView(R.layout.ble_activity);//  public static final int ble_activity = 2130903041;
        ...
        ((Button)findViewById(R.id.title_edit)).setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramView)
            {
                Intent intent = new Intent(Ble_Activity.this, firstview.class);
