...
import com.hrg.healthmanager.Infoadmin.result.displayresult;
...
public class checktheitems extends Activity {
    ...
    protected void onCreate(Bundle paramBundle)
    {
        ...
        setContentView(R.layout.checktodisplay);//  public static final int checktodisplay = 2130903043;
        ...
        if (this.dismodeString.endsWith("newdisplay"))
        {
            ...
            initFruits();
            this.adapter = new CheckItemAdapter(this, R.layout.checkitems, this.checkboxList); // public static final int checkitems = 2130903042;
            ...
            ((Button) findViewById(R.id.title_edit)).setOnClickListener(new View.OnClickListener() {
                public void onClick(View paramView) {
                    Intent intent = new Intent(checktheitems.this, firstview.class);
                    checktheitems.this.startActivity(intent);
