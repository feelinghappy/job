...
import com.hrg.robotproject.service.VideoCallService;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnget = (Button)findViewById(R.id.getvalue);
        tvuid = (TextView)findViewById(R.id.uid);
        TextView tv = (TextView)findViewById(R.id.details);
        btnget.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent startIntent = new Intent(MainActivity.this, VideoCallService.class);
            ...
            public void run() {
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        Toast.makeText(MainActivity.this, strfromserver, Toast.LENGTH_SHORT).show();
