...
import com.longcai.medical.bean.UnOrderList;
...
public class AllUnOrderAdapter extends BaseAdapter {

    private Context mContext;
    private List<UnOrderList> data;
    private String orderState;

    public AllUnOrderAdapter(Context context, List<UnOrderList> data) {
        this.mContext = context;
        this.data = data;
    }

    public void setData(List<UnOrderList> data) {
        if (!data.isEmpty()) {
            this.data.clear();
        }
...
//        long paymentTime = order.getPayment_time();
       ...
       vh.tvTime.setText(StringUtils.toTime(String.valueOf(createTime)));
        if (order_state == 0) {
            orderState = "已关闭";
//            vh.tvTime.setText(StringUtils.refFormatNowDate(paymentTime * 1000));
