 ...
 * 机器人Adapter
 */
public class PersonRobotAdapter extends BaseAdapter {//person_device_list_item
    private List<Robot> mList;
    private LayoutInflater mInflater;
    private Context context;

    public PersonRobotAdapter(Context context, List<Robot> mList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String familyName = mList.get(position).getFamily_name();
        if (null != familyName) {
            myHolder.name_device_item.setText(familyName);
        } else {
