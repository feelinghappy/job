...
import com.longcai.medical.rob.ui.CalledActivity;
...
public class VideoCallUA {
        ...
        public void onCallResponse(CallStatus callStatus) {
            ...
            switch (callStatus){
                case ACCEPTED:
                    ...
                    intent.putExtra(CALL_OR_MONITOR, withControl);
     ...
     * @param data
     */
    public  void callVideoWithControl(String remoteUid, String data){
        withControl = true;
        callVideo(remoteUid, data);
    }
