...
public class SystemMessageActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mInflater = LayoutInflater.from(SystemMessageActivity.this);
        initData();
    }
    ...
    private void getData() {
        ...
        //TODO MainActivity中系统消息和家庭消息集合添加到了 msgList，
    ...
    private void getMsgData() {
        ...
        messageAdapter = new MessageAdapter(SystemMessageActivity.this, msgInfoList);
        ...
        messageLv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                String message_id = msgInfoList.get(position).getMessage_id();
                String message_type = msgInfoList.get(position).getMessage_type();
                popupWindow = new ShowPopupWindow(SystemMessageActivity.this).showPopup(delete_pop);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (resultCode) {
            ...
            case Constant.RESULT_READ_NOTICE:
                ...
                messageLv.setAdapter(messageAdapter);
                messageAdapter.notifyDataSetChanged();
                if (!msgInfoList.get(sysPosition).getNotice().equals("0")) {
                    Constant.isAllRead = true;
                }
