...
public class KCalendar extends ViewFlipper implements
    ...
    public static final int COLOR_BG_WEEK_TITLE = Color.parseColor("#ffffff"); // 星期标题背景颜色("#ffeeeeee")
    public static final int COLOR_TX_WEEK_TITLE = Color.parseColor("#26afdc"); // 星期标题文字颜色("#ffcc3333")
    ...
    public static final int COLOR_TX_THIS_DAY = Color.parseColor("#26afdc"); // 当天日历数字颜色("#ff008000")
