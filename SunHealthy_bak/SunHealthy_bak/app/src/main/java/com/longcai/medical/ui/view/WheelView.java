...
//        MyApplication.ScaleScreenHelper.loadView((ViewGroup) views);
        addView(views);
    }
    ...
    private TextView createView(String item) {
        ...
        if (0 == itemHeight) {
            ...
            LogUtils.d("itemHeight: " + itemHeight);
...
//        MyApplication.ScaleScreenHelper.loadView((ViewGroup)views);
    ...
    private void onSelectedCallBack() {
        if (null != onWheelViewListener) {
            ...
            LogUtils.v("isUserScroll=" + isUserScroll + ",selectedIndex=" + selectedIndex + ",realIndex=" + realIndex);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                LogUtils.d( String.format("items=%s, offset=%s", items.size(), offset));
    ...
    private class ScrollerTask implements Runnable {
        ...
        public void run() {
            ...
            if (initialY - newY == 0) { // stopped
                ...
                LogUtils.d( "initialY: " + initialY + ", remainder: " + remainder + ", divided: " + divided);
                if (remainder == 0) {
