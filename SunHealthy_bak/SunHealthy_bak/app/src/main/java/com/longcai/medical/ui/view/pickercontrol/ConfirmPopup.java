package com.longcai.medical.ui.view.pickercontrol;
...
import com.longcai.medical.ui.view.util.ConvertUtils;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected final View makeContentView() {
        ...
        rootLayout.setLayoutParams(new LinearLayout.LayoutParams(WRAP_CONTENT, WRAP_CONTENT));
        ...
        if (topLineVisible) {
            ...
            lineView.setLayoutParams(new LinearLayout.LayoutParams(WRAP_CONTENT, 1));
            lineView.setBackgroundColor(topLineColor);
            rootLayout.addView(lineView);
        }
        rootLayout.addView(makeCenterView(), new LinearLayout.LayoutParams(WRAP_CONTENT, 0, 1.0f));
