...
import com.longcai.medical.ui.view.WheelView;
    ...
    public void setSelectedItem(String firstText, String secondText, String thirdText) {
        for (int i = 0; i < firstList.size(); i++) {
            ...
            if (ft.contains(firstText)) {
                ...
                LogUtils.d("init select first text: " + ft + ", index:" + selectedFirstIndex);
                break;
            }
        }
        ...
        for (int j = 0; j < secondTexts.size(); j++) {
            ...
            if (st.contains(secondText)) {
                ...
                LogUtils.d("init select second text: " + st + ", index:" + selectedSecondIndex);
                break;
            }
        }
        ...
        for (int k = 0; k < thirdTexts.size(); k++) {
            ...
            if (tt.contains(thirdText)) {
                ...
                LogUtils.d("init select third text: " + tt + ", index:" + selectedThirdIndex);
                break;
            }
        }
    }
