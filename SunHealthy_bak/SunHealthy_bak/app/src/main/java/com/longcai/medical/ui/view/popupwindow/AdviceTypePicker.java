...
public class AdviceTypePicker extends PopupWindow implements View.OnClickListener, PopupWindow.OnDismissListener {
    private kankan.wheel.widget.WheelView mContentWheel;
    private Activity activity;
    private Button mCancelBtn;
    private Button mOKBtn;
    private IAdviceTypePicker iAdviceTypePicker;
    private String[] items;
    private TextView mTitleTxt;

    public AdviceTypePicker(final Activity context) {
        super(context);
...
//        this.setOutsideTouchable(true);
        ...
        items = context.getResources().getStringArray(R.array.advice_type);
    ...
    public void setIAdviceTypePicker(IAdviceTypePicker iAdviceTypePicker) {
        this.iAdviceTypePicker = iAdviceTypePicker;
    }
...
//            this.showAsDropDown(parent);
    ...
    public void onClick(View view) {
        if (view == mCancelBtn) {
            ...
            if (null != iAdviceTypePicker) {
                iAdviceTypePicker.adviceTypePicker(selectedItem, items[selectedItem]);
            }
            dismiss();
        }
    }
    ...
    public interface IAdviceTypePicker {
        void adviceTypePicker(int item, String itemName);
    }
}
