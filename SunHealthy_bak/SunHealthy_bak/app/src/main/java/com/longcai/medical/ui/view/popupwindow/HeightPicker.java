...
public class HeightPicker extends PopupWindow implements View.OnClickListener, PopupWindow.OnDismissListener {
    private kankan.wheel.widget.WheelView mContentWheel;
    private Activity activity;
    private Button mCancelBtn;
    private Button mOKBtn;
    private IHeightPicker iHeightPicker;
    private TextView mTitleTxt;

    public HeightPicker(final Activity context) {
        super(context);
...
//        this.setOutsideTouchable(true);
        ...
        NumericWheelAdapter numericAdapter = new NumericWheelAdapter(activity, 100, 280, "%d cm");
        mContentWheel.setViewAdapter(numericAdapter);
        mContentWheel.setCurrentItem(60);
    ...
    public void setIHeightPicker(IHeightPicker iHeightPicker) {
        this.iHeightPicker = iHeightPicker;
    }
    ...
    public void onClick(View view) {
        if (view == mCancelBtn) {
            ...
            if (null != iHeightPicker) {
                iHeightPicker.heightPicker(selectedItem);
            }
            dismiss();
        }
    }
    ...
    public interface IHeightPicker {
        void heightPicker(int item);
    }
}
