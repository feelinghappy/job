...
public class ProfessionPicker extends PopupWindow implements View.OnClickListener, PopupWindow.OnDismissListener {
    private kankan.wheel.widget.WheelView mContentWheel;
    private Activity activity;
    private Button mCancelBtn;
    private Button mOKBtn;
    private IProfessionPicker iProfessionPicker;
    private String[] items;
    private TextView mTitleTxt;

    public ProfessionPicker(final Activity context) {
        super(context);
...
//        this.setOutsideTouchable(true);
        ...
        items = context.getResources().getStringArray(R.array.profession);
    ...
    public void setIProfessionPicker(IProfessionPicker iProfessionPicker) {
        this.iProfessionPicker = iProfessionPicker;
    }
    ...
    public void onClick(View view) {
        if (view == mCancelBtn) {
            ...
            if (null != iProfessionPicker) {
                iProfessionPicker.professionPicker(selectedItem, items[selectedItem]);
            }
            dismiss();
        }
    }
    ...
    public interface IProfessionPicker {
        void professionPicker(int item, String itemName);
    }
}
