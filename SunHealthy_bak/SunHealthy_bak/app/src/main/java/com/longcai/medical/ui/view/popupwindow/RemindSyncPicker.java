...
public class RemindSyncPicker extends PopupWindow implements View.OnClickListener, PopupWindow.OnDismissListener {
    private kankan.wheel.widget.WheelView mContentWheel;
    private Activity activity;
    private Button mCancelBtn;
    private Button mOKBtn;
    private IRemindSyncPicker iRemindSyncPicker;
    private String[] items;
    private TextView mTitleTxt;

    public RemindSyncPicker(final Activity context) {
        super(context);
...
//        this.setOutsideTouchable(true);
        ...
        items = context.getResources().getStringArray(R.array.remind_step);
    ...
    public void setIRemindSyncPicker(IRemindSyncPicker iRemindSyncPicker) {
        this.iRemindSyncPicker = iRemindSyncPicker;
    }
    ...
    public void onClick(View view) {
        if (view == mCancelBtn) {
            ...
            if (null != iRemindSyncPicker) {
                iRemindSyncPicker.remindSync(selectedItem, items[selectedItem]);
            }
            dismiss();
        }
    }
    ...
    public interface IRemindSyncPicker {
        void remindSync(int item, String itemName);
    }
}
