...
public class SexPicker extends PopupWindow implements View.OnClickListener, PopupWindow.OnDismissListener {
    private kankan.wheel.widget.WheelView mContentWheel;
    private Activity activity;
    private Button mCancelBtn;
    private Button mOKBtn;
    private ISexPicker iSexPicker;
    private String[] items;
    private TextView mTitleTxt;

    public SexPicker(final Activity context) {
        super(context);
...
//        this.setOutsideTouchable(true);
        ...
        items = context.getResources().getStringArray(R.array.sex);
    ...
    public void setISexPicker(ISexPicker iSexPicker) {
        this.iSexPicker = iSexPicker;
    }
    ...
    public void onClick(View view) {
        if (view == mCancelBtn) {
            ...
            if (null != iSexPicker) {
                iSexPicker.sexPicker(selectedItem, items[selectedItem]);
            }
            dismiss();
        }
    }
    ...
    public interface ISexPicker {
        void sexPicker(int item, String itemName);
    }
}
