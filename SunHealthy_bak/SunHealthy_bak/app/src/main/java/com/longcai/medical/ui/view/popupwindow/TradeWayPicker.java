...
public class TradeWayPicker extends PopupWindow implements View.OnClickListener, PopupWindow.OnDismissListener {
    private kankan.wheel.widget.WheelView mContentWheel;
    private Activity activity;
    private Button mCancelBtn;
    private Button mOKBtn;
    private ITradeWayPicker iTradeWayPicker;
    private String[] items;
    private TextView mTitleTxt;

    public TradeWayPicker(final Activity context) {
        super(context);
...
//        this.setOutsideTouchable(true);
        ...
        items = context.getResources().getStringArray(R.array.trade_way);
    ...
    public void setITradeWayPicker(ITradeWayPicker iTradeWayPicker) {
        this.iTradeWayPicker = iTradeWayPicker;
    }
    ...
    public void onClick(View view) {
        if (view == mCancelBtn) {
            ...
            if (null != iTradeWayPicker) {
                iTradeWayPicker.tradeWayPicker(selectedItem, items[selectedItem]);
            }
            dismiss();
        }
    }
    ...
    public interface ITradeWayPicker {
        void tradeWayPicker(int item, String itemName);
    }
}
