...
public class WeightPicker extends PopupWindow implements View.OnClickListener, PopupWindow.OnDismissListener {
    private kankan.wheel.widget.WheelView mContentWheel;
    private Activity activity;
    private Button mCancelBtn;
    private Button mOKBtn;
    private IWeightPicker iWeightPicker;
    private TextView mTitleTxt;

    public WeightPicker(final Activity context) {
        super(context);
...
//        this.setOutsideTouchable(true);
        ...
        NumericWheelAdapter numericAdapter = new NumericWheelAdapter(activity, 20, 260, "%d kg");
        mContentWheel.setViewAdapter(numericAdapter);
        mContentWheel.setCurrentItem(40);
        mContentWheel.setVisibleItems(7);
    }

    public void setIWeightPicker(IWeightPicker iWeightPicker) {
        this.iWeightPicker = iWeightPicker;
    }
    ...
    public void onClick(View view) {
        if (view == mCancelBtn) {
            ...
            if (null != iWeightPicker) {
                iWeightPicker.weightPicker(selectedItem);
            }
            dismiss();
        }
    }
    ...
    public interface IWeightPicker {
        void weightPicker(int item);
    }
}
