package com.longcai.medical.ui.view.recyclerview;
...
public class RecyclerViewStateUtils {
    static LoadingFooter footerView = null;
    ...
    public static LoadingFooter.State getFooterViewState(RecyclerView recyclerView) {
        ...
        if (outerAdapter != null && outerAdapter instanceof HeaderAndFooterRecyclerViewAdapter) {
            if (((HeaderAndFooterRecyclerViewAdapter) outerAdapter).getFooterViewsCount() > 0) {
                LoadingFooter footerView = (LoadingFooter) ((HeaderAndFooterRecyclerViewAdapter)
                        outerAdapter).getFooterView();
