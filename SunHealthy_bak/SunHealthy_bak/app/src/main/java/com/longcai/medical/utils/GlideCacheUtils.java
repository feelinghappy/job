...
public class GlideCacheUtils {
    ...
    public static long getCacheSizeLong() {
        try {
            return getFolderSize(Glide.getPhotoCacheDir(MyApplication.getInstance()));
        } catch (Exception e) {
            return 0;
        }
    }
    ...
    public static boolean cleanCatchDisk() {
        return deleteFolderFile(Glide.getPhotoCacheDir(MyApplication.getInstance()).getAbsolutePath(), false);
    }
