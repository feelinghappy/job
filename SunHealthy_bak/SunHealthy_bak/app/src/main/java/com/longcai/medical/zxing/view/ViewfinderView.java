...
package com.longcai.medical.zxing.view;
...
//    canvas.drawRect(frame.left + 2, middle - 1, frame.right_arrow - 1, middle + 2, paint);
        //线性渐变
        ...
        if (scannerStart <= scannerEnd) {
            //矩形
//      canvas.drawRect(frame.left, scannerStart, frame.right_arrow, scannerStart + SCANNER_LINE_HEIGHT, paint);
            //椭圆
